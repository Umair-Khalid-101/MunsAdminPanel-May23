...
const Card = ({
  ...
  return (
    <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow">
      <p>
        <img className="rounded-t-lg" src={incidentImage} alt="incidentImage" />
      </p>
      <div className="p-5">
        <p>
        ...
        <p className="mb-3 font-normal text-gray-700">{other}</p>
        <p className="mb-3 font-normal text-gray-700">{propertyname}</p>
