...
export default function Valet() {
  ...
  const routes = [
    { label: "Independence Place", value: "Independence Place" },
    { label: "Lake Fairway", value: "Lake Fairway" },
    { label: "Sun Hollow", value: "Sun Hollow" },
    { label: "Ridgemar", value: "Ridgemar" },
    { label: "Spring Park", value: "Spring Park" },
    {
      label: "Cliffside at Mountain Park",
      value: "Cliffside at Mountain Park",
    },
    {
      label: "Desert Commons",
  ...
  const formSchema = yup.object().shape({
    ...
    // route: yup.string().required("Route Cannot be Empty!"),
  ...
  const onSubmit = async (data) => {
    ...
    await createUserWithEmailAndPassword(auth, email, password)
      .then(async (userCredential) => {
        ...
        // console.log("Valet Created:", user);
        try {
